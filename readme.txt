...
PACKAGES THAT IS WP-ADMIN-BAR-REMOVAL - WP-TOOLBAR-REMOVAL
PLEASE USE IT - NO ASSISTANCE AND SUPPORT IS GIVEN FOR
BRUTEFORCE PLUGIN NOW AND FUTURE FOR ANY REASON OF ANY TYPE
BECAUSE CODE IS POETRY AND NOT CLONE OF OTHER WORKS - THANKS
`

NOT USE BOTH MAIN AND BRUTE FORCE PLUGIN AT THE SAME TIME!

= Main Plugin Features (FRONT END HIDER) =

* Hide Front End Admin Bar or Toolbar for logged in roles
* Hide Your Profile Option "Show Admin Bar when viewing site"
* Hide Your Profile Option "Show Toolbar when viewing site"
* Settings Page with Plugin Options Control Panel
* Settings Auto Clean Plugin
* Work on all WordPress version from 3.1+ to 4.4+

NOT USE BOTH MAIN AND BRUTE FORCE PLUGIN AT THE SAME TIME!

= Extra Plugin Features (BRUTE FORCE BACK END) Discontinued =

* Hide Front and Back End Admin Bar or Toolbar for all roles
* Hide Your Profile Option "Show Admin Bar when viewing site"
* Hide Your Profile Option "Show Toolbar when viewing site"
...
global options to hide front end admin bar or toolbar for logged roles
...
* Disable it from menu plugins of control panel
* Delete it from menu plugins of control panel

= Troubleshooting =

WARNING: DO NOT USE AND ACTIVATE BOTH THIS AND OTHER PLUGINS AT THE SAME TIME - NO ASSISTANCE AND SUPPORT IS GIVEN NOW AND FUTURE FOR ANY REASON OF ANY TYPE!

== Frequently Asked Questions ==

simply adds an options page to turn front end admin bar or toolbar off

How does it work?

The plugin add more global options to the settings menu to globally turn off (hide) the front end admin bar or toolbar and turn off (hide) the user personal options field in the profile to view it on dashboard.

= Can remove back end admin bar toolbar in WordPress 3.1+ or later? =

WordPress does not provide an easy method to remove the Admin Bar and Toolbar in the back end, so is possible use [WP Admin Bar Removal](https://wordpress.org/plugins/wp-admin-bar-removal/) or [WP Toolbar Removal](https://wordpress.org/plugins/wp-toolbar-removal/) plugins that takes a different approach to override it!
...
1.  Hide Admin Bar and Toolbar Global Options Settings
2.  Hide Admin Bar and Toolbar Global Admin Menu Settings
3.  Hide Admin Bar and Toolbar Global User Profile Personal Options
...
[sLaNGjIs team do not providing support on wordpress.org forum and reviews](https://wordpress.org/plugins/global-admin-bar-hide-or-remove/other_notes/) because we are not interested in reviews o stars on our plugins!
...
Full BuddyPress Support 2016

Full Multisite Support 2015

Full User Roles Support 2014
 ...
 * NEW support and compatibility for WordPress 3.8+
 * NEW support and compatibility for WordPress 3.7+
 * NEW support and compatibility for WordPress 3.6+
 * NEW support and compatibility for WordPress 3.5+
 * NEW support and compatibility for WordPress 3.4+
 * NEW support and compatibility for WordPress 3.3+
 * NEW support and compatibility for WordPress 3.2+
 * NEW support and compatibility for WordPress 3.1+
 ...
 * ACTIVATION check minimun version required
 * DEACTIVATION clean registered db options hooks
 * ENHANCEMENT code cleanup for faster loading
 * ENHANCEMENT reduce code bloat
 * ENHANCEMENT ready to single and multisite environment
 * ENHANCEMENT less plugin memory consumption
 * ENHANCEMENT full strict security rules applied
 * ENHANCEMENT work with shared, vps, dedicated hosting
 * ENHANCEMENT compatible with cloud hosting
